 ...
 *
 *     node apps/web/src/views/TimelineEditor/mediaDownloads.test.mjs
 *
...
globalThis.fetch = async () => ({
  ok: true,
  headers: { get: (h) => (h === 'content-length' ? '1000' : 'audio/wav') },
  body: {
    getReader() {
      let i = 0
...
const registry = await import(
  process.argv[2] ?? '/Users/larskrs/Utvikling/project-starling/apps/web/src/views/TimelineEditor/mediaDownloads.js'
)
