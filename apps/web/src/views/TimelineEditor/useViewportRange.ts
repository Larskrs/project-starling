 ...
 */
export function useViewportRange(marginPx = 0): ComputedRef<ViewportRange> {
  const viewport = inject<Ref<EditorViewport>>('editor-viewport', ref({ scrollLeft: 0, width: 0 }))
  return computed(() => {
